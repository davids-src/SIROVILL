        ...
        <div className="relative mx-auto max-w-site px-6">
          <Reveal className="max-w-3xl">
            ...
            <p className="mt-5 text-base text-muted sm:text-lg">
              Épületvillamosság, felújítás, építkezés és okosotthon témájú
              cikkek a SIROVILL szakértőitől.
            </p>
          </Reveal>
        </div>
      </section>
          ...
          <Reveal className="max-w-2xl">
            <div className="rounded-lg border border-line bg-surface p-12 text-center">
              <p className="text-base text-muted sm:text-lg">
                Hamarosan érkeznek az első cikkek. A felmérés és az ajánlat
                viszont már most díjmentes.
              </p>
              <Link
                to="/kapcsolat"
                className="mt-6 inline-flex items-center gap-2 rounded bg-amber px-6 py-3 text-sm font-semibold text-bg transition-transform duration-150 ease-out hover:scale-[1.02]"
