...
export function RolunkPage() {
  return (
    <>
      <Seo
        title="Rólunk — SIROVILL"
        ...
        <div className="relative mx-auto max-w-site px-6">
          <Reveal className="max-w-3xl">
            ...
            <p className="mt-5 text-base text-muted sm:text-lg">
              A SIROVILL a SIROTECH Kft. legújabb divíziója — villanyszerelési
              szolgáltatással bővítjük azt, amit eddig is csináltunk.
            </p>
          </Reveal>
        </div>
      </section>
      ...
      <Section>
        <Reveal className="max-w-3xl">
          <p className="text-base text-ink sm:text-lg">
            2021 óta dolgozunk informatikai és biztonságtechnikai területen.
            Eddig is mi kábeleztünk a hálózat- és kamerarendszer-telepítéseknél
            — csak ott, ahol a villamos munka kezdődött, át kellett adni
            valaki másnak. 2026 novemberétől ez megszűnik: saját villanyszerelő
            kollégával bővülünk, hogy egy csapat tudja végigvinni a teljes
            kivitelezést.
          </p>
        </Reveal>
      </Section>
