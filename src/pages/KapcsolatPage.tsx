...
export function KapcsolatPage() {
  const [params] = useSearchParams();
  const forras = params.get("forras") ?? "sirovill-kapcsolat";
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      helyszin: data.get("helyszin"),
      munka: data.get("munka"),
      uzenet: data.get("uzenet"),
      forras,
    };

    try {
      const apiUrl = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/sirovill-contact`;
  ...
  return (
    <>
      <Seo
        ...
        description="Kérje ingyenes felmérését. 1 munkanapon belül jelentkezünk az időpont-egyeztetésre. A felmérés és az ajánlat díjmentes, a kivitelezés november 1-től indul."
      />
      ...
      <Section>
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
          <Reveal className="lg:col-span-7">
            {status === "success" ? (
              <div className="rounded-lg border p-8" style={{ borderColor: `${ACCENT}40`, background: `${ACCENT}12` }}>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm text-ink sm:text-base">
                      Köszönjük megkeresését! 1 munkanapon belül felvesszük
                      Önnel a kapcsolatot.
                    </p>
                    <button
              ...
              <form onSubmit={onSubmit} className="space-y-5" noValidate>
                ...
                {status === "error" && (
                  <div className="flex items-start gap-2 rounded border px-4 py-3 text-sm" style={{ borderColor: "#E8271A40", background: "#E8271A12", color: "#F0F0F5" }}>
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded bg-amber px-6 py-3 text-sm font-semibold text-bg transition-transform duration-150 ease-out hover:scale-[1.02] disabled:opacity-50"
          ...
          <Reveal className="lg:col-span-5" delay={0.1}>
            <div className="space-y-4">
              ...
              <div className="rounded-lg border p-6" style={{ borderColor: `${ACCENT}40`, background: `${ACCENT}12` }}>
                <p className="text-sm text-ink">
                  A felmérés és a rögzített áras ajánlat már most díjmentes. A
                  kivitelezés 2026. november 1-től indul.
                </p>
              </div>
            </div>
          </Reveal>
